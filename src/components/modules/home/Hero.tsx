          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <div className="space-y-2">
                <h1 className="text-[51px] leading-[50px] md:leading-[60px]">
                  {heading.line1}
                </h1>
                <h1 className="text-[51px] leading-[50px] md:leading-[60px]">
                  {heading.line2}
              ...
              {/* Description */}
              <div className="space-y-1 md:leading-7 text-gray-600">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                {buttons.primary && (
                  <Button
                    ...
                    className="h-[50px] gap-2 rounded-xl bg-blue-600 px-8 text-[15.3px] hover:bg-blue-700"
                  >
                ...
                {buttons.secondary && (
                  <Button
                    ...
                    variant="outline"
                    className="h-[50px] gap-2 rounded-xl border-blue-600 px-8 text-[15.3px] text-blue-600 hover:text-blue-700 hover:bg-blue-50"
                  >
            ...
            <div className="flex items-center justify-center lg:justify-end">
              <div className="w-full max-w-[559.929px] rounded-2xl bg-white p-8 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
                ...
                <form className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    className="h-[50px] w-full rounded-xl bg-blue-600 text-[15.3px] hover:bg-blue-700"
                  >
                    {formCard.submitText}
                  </Button>
                </form>
